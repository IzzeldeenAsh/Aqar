...
const ContactArea = () => {
  ...
  <section className="contact-area mb-45">
      <div className="container">
            ...
            <div className="col-lg-6">
                <div className="tpcontact-inner text-center mt-20 mb-40">
                  <div className="tpcontact-inner-text">
                      ...
                      <h5 className="tpcontact-inner-title mb-20">Looking For Aqar?</h5>
          ...
          <div className="row">
            <ContactItem img="1" title="Rue Pelleport - Paris" add="Heaven Stress, Beverly Melbourne" phone="(+100) 123 456 7890" email="Aqar@google.com"/>
            <ContactItem img="2" title="Prospect - New York" add="Heaven Stress, Beverly Melbourne" phone="(+100) 123 456 8899" email="Aqar@google.com"/>
            <ContactItem img="3" title="Budapest - Hungary" add="Heaven Stress, Beverly Melbourne" phone="(+100) 123 456 7755" email="Aqar@google.com"/>
            <ContactItem img="4" title="Kastrup - Denmark" add="Heaven Stress, Beverly Melbourne" phone="(+100) 123 456 5544" email="Aqar@google.com"/>
          </div>
      </div>
    </section>
  );
