    ...
    productInfoList: [
      {
        ...
        infoArray: {
          ...
          ar: [
            ...
            "توفير الجرعة الكاملة الصافية من الحديد بنسبة 30 مغ في الحبة الواحدة وهي الجرعة الموصى للحامل يوميا",
            "توفير الفوليك أسيد بنسبة 400 مكغ صافي ليغطي احتياج المرأة الحامل اليومي",
    ...
    productInfoList: [
      {
        ...
        infoArray: {
          ...
          ar: [
            "يساعد في تخفيف أعراض التهاب المسالك البولية و آلام الجهاز البولي التي قد تصيب مرضى السكري، النساء الحوامل، النساء في سن اليأس، الأشخاص بعد عملية القسطرة البولية، المرضعات، والحوامل.",
      ...
      },
      {
        ...
        infoArray: {
          ...
          ar: [
            "<strong>التوت البري 200 مغ</storng><br>",
            "* التي لها تأثير كمضاد للأكسدة و يمنع التصاق البكتيريا الضارة في الحالب، وجدران المثانة ويخرجها إلى خارج الجسم",
            "*<strong>خلطة بروبيوتيك خاصة 70 مغ</strong>",
            "  ذات قدرة على منع التصاق ونمو البكتيريا الضارة داخل المسالك البولية.",
            "أيضاً يتميز البروبيوتيك عن المضادات الحيوية الوقائية في أنه لا تحدث مقاومة له، على عكس المضادات الحيوية التي قد تظهر البكتيريا اساليب دفاعية تجاهه، و يصبح غير فعال في مكافحتها",
            "<strong>*مانوز 700مغ</strong>"
          ]
        }
      },
      {
...
,    
  ...
  "زيت بذرة نبات القرع (اليقطين) بتركيز 300 مغ",
  "بلميط منشاري مستخلص بتركيز 250 مغ",
  "خوخ أفريقي 10 مغ",
  "زنك 15 مكغ",
  "سيلينيوم 50 مكغ",
  "ارجينين 200 مغ",
  "كوير سيتين 10 مغ"
      ...
      },
      {
        ...
        infoArray: {
          ...
          ar: [
            "يساعد في تقليل حجم مشاكل تضخم البروستات الحميد.",
            "يساعد في الحد من أعراض التهاب المثانة ويقلل من فرصة حدوثها.",
            "يساعد في تقليل احتباس البول والحرقة وتقطع البول.",
            "له دور في تقليل مشاكل الانتصاب.",
